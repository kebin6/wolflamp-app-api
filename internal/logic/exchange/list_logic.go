...
func (l *ListLogic) List(req *types.ListExchangeReq) (resp *types.ListExchangeResp, err error) {
	...
	data, err := l.svcCtx.WolfLampRpc.ListExchange(l.ctx,
		&wolflamp.ListExchangeReq{
			Page:     req.Page,
